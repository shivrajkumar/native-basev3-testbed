  ...
  .add("Web Layout", () => (
    <Stack height={number("height", "100%")} bg="gray.5">
      <Columns flexGrow={number("flexGrow", 1)}>
        <Stack bg="pink.5" width={0.2 / 1} height={number("height", "100%")} bg="gray.5">
          <Column bg="pink.2" width={0.9 / 1} flexGrow={number("flexGrow", 1)} />
        </Stack>
        <Stack bg="gray.5" width={0.8 / 1} height={number("height", "100%")} bg="gray.5">
          <Columns bg="green.1" width={0.8 / 1} flexGrow={number("flexGrow", 1)}>
            <Column
              bg="red.1"
              width={0.2 / 1}
