...
storiesOf("Primitives", module)
  ...
  .add("Web Layout", () => (
    <Stack height={number("height", "100%")}>
      <Columns height={number("height", "100%")}>
        <Column bg="pink.2" flexGrow={number("flexGrow", 1)} width={0.15 / 1} />
        <Columns height={number("height", "100%")} bg="gray.5" width={0.85 / 1}>
          <Column bg="green.2" flexGrow={number("flexGrow", 1)} width={0.15 / 1} />
          <Column flexGrow={number("flexGrow", 1)} bg="red.3" width={0.85 / 1}>
            <Text>Test</Text>
          </Column>
        </Columns>
      </Columns>
