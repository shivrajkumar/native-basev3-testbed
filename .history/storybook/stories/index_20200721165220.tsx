  ...
  .add("Web Layout", () => (
    <Stack height={number("height", "100%")} bg="gray.5">
      <Columns flexGrow={number("flexGrow", 1)}>
        <Column bg="pink.2" flexGrow={number("flexGrow", 1)} />
        <Columns bg="gray.5" flexGrow={number("flexGrow", 1)}>
          <Column bg="green.2" flexGrow={number("flexGrow", 1)} width={number("width", 200)} />
          <Column flexGrow={number("flexGrow", 1)} bg="red.3" width={number("width", 200)}>
            <Text>Test</Text>
          </Column>
        </Columns>
      </Columns>
