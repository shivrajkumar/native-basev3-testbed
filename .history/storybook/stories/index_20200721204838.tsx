    ...
    <Columns flexGrow={number("flexGrow", 1)}>
      ...
      <Column bg="gray.2" width={0.8 / 1} flexGrow={number("flexGrow", 1)}>
        <Stack height={number("height", 200)} flexGrow={number("flexGrow", 1)}>
          ...
          <Box bg="gray.2" height={65} />
          <Columns flexGrow={number("flexGrow", 1)} bg="green.1">
            <Column space="medium" bg="green.3" flexGrow={number("flexGrow", 1)} />
            <Column bg="green.4" flexGrow={number("flexGrow", 1)} />
            <Column bg="green.5" flexGrow={number("flexGrow", 1)} />
            {/* <Box
            bg="gray.4"
