...
export default (
  ...
  console.log(childrenArray, "childrenArray", children);
  /*
  ...
  */
  const cArray: JSX.Element[] = cArray.push(childrenArray[0]);
  cArray.push(trailingChildrenWithSpacing);
  console.log(childrenArray[0], ...trailingChildrenWithSpacing, "childrenArray 222");
